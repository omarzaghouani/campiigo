...
public class TranspoteurService implements itService<Transpoteur> {
    ...
    public boolean addt(Transpoteur tr) {
        ...
        String query = "INSERT INTO transporteur (num_ch, nom, prenom, numtel, email, daten, num_t) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void deletet(Transpoteur transpoteur) {
        String query = "DELETE FROM transporteur WHERE num_ch = ?";
        try (PreparedStatement psr = conn.prepareStatement(query)) {
    ...
    public void updatet(Transpoteur tr) {
        String query = "UPDATE transporteur SET nom = ?, prenom = ?, numtel = ?, email = ?, daten = ?, num_t = ? WHERE num_ch = ?";
        try (PreparedStatement psr = conn.prepareStatement(query)) {
    ...
    @Override
        ...
        public List<Transpoteur> readAll() {    String query = "SELECT * FROM transporteur";
    ...
    public Transpoteur readBynum_ch(int num_ch) {
        String query = "SELECT * FROM transporteur WHERE num_ch=?";
        try {
