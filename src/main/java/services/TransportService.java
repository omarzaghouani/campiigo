...
public class TransportService implements IoService<Transport> {
...
/*
    ...
    public void selecttranspoteurtransport(int num_ch) {
        String query = "SELECT * FROM transporteur JOIN transport ON transpoteur.num_ch = transport.num_ch WHERE transport.num_ch?";
